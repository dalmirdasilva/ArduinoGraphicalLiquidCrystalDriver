...
#define GRAPHICAL_LIQUID_CRYSTAL_PCD8544_BYTE_SIZE       (GRAPHICAL_LIQUID_CRYSTAL_PCD8544_HEIGHT_PAGES * GRAPHICAL_LIQUID_CRYSTAL_PCD8544_WIDTH)
...
public:
     ...
     * Public constructor.
     */
    GraphicalLiquidCrystalPCD8544(unsigned char mosiPin, unsigned char clockPin, unsigned char rstPin, unsigned char dcPin, unsigned char scePin);
