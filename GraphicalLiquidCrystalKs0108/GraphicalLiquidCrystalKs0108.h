...
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_USING_RESET                                 1

#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_CS1_PIN                                     12
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_CS2_PIN                                     13

#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_RS_PIN                                      3
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_RW_PIN                                      2
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_EN_PIN                                      A0

#ifdef GRAPHICAL_LIQUID_CRYSTAL_KS0108_USING_RESET
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_RESET_PIN                                   13
#endif
 ...
 * |                                                                   |
 * |          1                  :                  20                 |
 * |__________+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+__________________|
 *            | | | | | | | | | | | | | | | | | | | |
 *            | | | | | | | | | | | | | | | | | | | |            200K
 *      GND__/ /   \|_|_|_|_|_|_|_|_|_|_|_|_|_ \ \ \ \_________/\/\/\/\___GND
 *       5V___/     | | | | | | | | | | | | | \ \ \ \_____5V
 *                  | | | | | | | | | | | | |  \ \ \___________
 *             _____/ | | | | | | | | | | | |   \_\___________ \
 *            / ______/ | | | | | | | | | | |      \       __ \ \
 ...
 *          \ \/      _ /_|_|_|_|_|_|_|_|_/             5V  | + + + |
 *           \/\     / /  | | | | | | | |                   |__ P __|
 *           /\_\ __|_|___|_|_|_|_|_|_|_|____               |__|_|__|
 *          /    \__|_|___|_|_|_|_|_|_|_|____ \
 *         /        | |   | | | | | | | |    \ \
 *        /         | |  / / / /   \ \ \ \    \ \
 *       /    ______|_|_/ / / /     \ \ \ \____\_\________
 *      /    / _____|_|__/ / /       \ \ \______\_\______ \
 *     /    / / ____|_|__ / /         \ \________\_\____ \ \
 *    /    / / / ___|_|____/           \__________\_\__ \ \ \
 *   /    / / / /   | |                            \ \ \ \ \ \
 *  /  __|_|_|_|____|_|_____________________________\_\ \ \ \ \
 * |  /  | | | |    | |     9 8   7 6 5 4 3 2 1 0   / /|/ / / /
 ...
 *
 */
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_BUS_PIN_NIBBLE_LOW                          PIND
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_BUS_PIN_NIBBLE_HIGH                         PINB

#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_BUS_DDR_NIBBLE_LOW                          DDRD
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_BUS_DDR_NIBBLE_HIGH                         DDRB

#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_BUS_PORT_NIBBLE_LOW                         PORTD
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_BUS_PORT_NIBBLE_HIGH                        PORTB

// Data setup time TDSU ~= 300 ns (at 20Mhz it will be about 15 cycles)
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_DELAY_TDSU_US                               0x0a

// Data hold time (write) TDHW ~= 15 ns (at 20Mhz it will be about 1 cycles)
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_DELAY_TDHW_US                               0x0a

// Data delay time TDDR ~= 480 ns (at 20Mhz it will be about 25 cycles)
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_DELAY_TD_US                                 0x0a

// I don't know exactly how many cycles :/
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_DELAY_RESET_US                              0x0a

#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_CHECK_FOR_BUSY_ON_WRITE                     0x01
#define GRAPHICAL_LIQUID_CRYSTAL_KS0108_DEFAULT_ATTEMPTS_ON_BUSY                    0x0a

class GraphicalLiquidCrystalKs0108: public GraphicalLiquidCrystal {
